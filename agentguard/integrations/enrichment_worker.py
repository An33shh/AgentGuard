...
Run as a separate process alongside the AgentGuard API:
    ...
    python -m agentguard.integrations.enrichment_worker

Reads BLOCK/REVIEW events from the Redis 'agentguard:events' stream,
runs Claude security triage, and writes insights to the InsightsStore
and the 'agentguard:insights' Redis stream.
"""
